...
export default function Navbar() {
  return (
    <Popover className="fixed sm:absolute w-full z-50 bg-surface opacity-100 sm:opacity-80 text-secondary flex px-8">
      ...
      <div className="w-10/12">
        ...
        <div className="flex justify-between items-center border-tertiary-100 md:justify-start md:space-x-10">
          ...
          <div className="my-2 md:hidden">
            <Popover.Button className="bg-title_bg opacity-80 rounded-md p-2 inline-flex items-center justify-center text-tertiary-400 hover:text-tertiary-500 hover:bg-tertiary-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary-500">
              <span className="sr-only mx-6">Open menu</span>
              <MenuIcon className="h-6 w-6" aria-hidden="true" />
            </Popover.Button>
          </div>

          <div className="hidden md:flex space-x-0 lg:space-x-20 items-center justify-end md:flex-1 lg:w-0 uppercase">
      ...
      >
        ...
        >
          <div className="rounded-lg shadow-lg ring-1 ring-surface ring-opacity-5 bg-title_bg z-50">
            <div className="pt-2 pb-6 px-5">
              <div className="flex items-center justify-between">
                ...
                <div className="-mr-2 text-tertiary">
                  <Popover.Button className="bg-title_bg rounded-md p-2 inline-flex items-center justify-center text-primary-400 hover:text-primary-500 hover:bg-tertiary-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-red-500">
