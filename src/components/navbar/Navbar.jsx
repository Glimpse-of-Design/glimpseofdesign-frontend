      ...
      <div className="max-w-7xl">
        <div className="flex justify-between items-center  border-third-100 md:justify-start md:space-x-10">
          ...
          <div className="mr-4 my-2 md:hidden">
            <Popover.Button className="bg-main opacity-80 rounded-md p-2 inline-flex items-center justify-center text-third-400 hover:text-third-500 hover:bg-third-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary-500">
            ...
            <div className="pt-2 pb-6 px-5">
              <div className="flex items-center justify-between">
                ...
                <div className="-mr-2 text-third">
                  <Popover.Button className="bg-secondary rounded-md p-2 inline-flex items-center justify-center text-primary-400 hover:text-primary-500 hover:bg-third-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-red-500">
