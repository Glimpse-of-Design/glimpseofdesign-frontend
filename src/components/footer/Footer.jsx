            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 pb-12">
              ...
              <span className="flex flex-row flex-nowrap items-center">
                {" "}
                  {
                      user ?
                          <span onClick={logout}> {user.email} <br/>Logged Out <BiUserCircle className="ml-2 text-2xl"/></span> :
                          <span onClick={() => navigate("login")}>Login as Admin <BiUserCircle
                              className="ml-2 text-2xl"/></span>
                  }
              </span>
                    </section>
                </div>
